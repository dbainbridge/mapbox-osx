...
//        UIGraphicsPushContext(context);
        ...
        if (IS_VALID_TILE_IMAGE(tileImage))
        {
            ...
            if (_mapView.debugTiles)
            {
                ...
                [newTile drawInRect:rect fromRect:NSZeroRect operation:NSCompositeSourceOver fraction:1.0];
                //tileImage = [UIImage imageWithNSImage:newTile];
                /*
